<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	if(session.getAttribute("drivername")==null)
	{
...
<body>
	...
	<section id="title">
		...
		<div class="container-fluid">
			<nav class="navbar navbar-expand-lg navbar-light bg-dark">
				...
				<h3 class="text-white bg-dark">Welcome ${drivername }</h3>
				<div class="collapse navbar-collapse d-flex justify-content-end "
					id="navbarNav">

					<ul class="navbar-nav">
						<li class="nav-item"><a class="nav-link" href="driverpage.jsp"><i
								class="fas fa-home"></i>Home</a></li>
						<li class="nav-item"><a class="nav-link"
							href="mailto:ravikj17@gmail.com">Contact us</a></li>
						<form class="form-inline my-2 my-lg-0" action="DriverLogout"
							method="post">
	...
	<section style="padding: 7% 15%;">
		...
		<table class="table bg-light">
			...
			<tbody>
				...
				<%
					...
					ps = connection.prepareStatement("select * from ride where driverid=?");
		...
		<form action="updatelocation" method="post">
			...
			<button type="submit" class="btn btn-danger ">Update live location</button>
			
		</form>
		<form action="cancelbooking" method="post">
			<button type="submit" class="btn btn-danger btn-lg" name="submit" value="completed">Finish ride</button>
		</form>
	</section>
